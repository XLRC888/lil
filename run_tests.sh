...
run_test "func_math_random" "function math random" ""
run_test "func_math_randint" "function math randint 1 6" ""
run_test "func_math_choice" "function math choice a b c" ""
run_test "func_math_eval" 'x = function math eval "2 + 3"' "5"
run_test "func_string_upper" 'x = function string upper "hello"' "HELLO"
run_test "func_math_factors" "x = function math factors 12" ""
run_test "func_math_fib" "x = function math fib 5" ""
run_test "func_math_isprime" "x = function math isprime 7" "1"
