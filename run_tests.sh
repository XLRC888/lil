...
run_test "func_math_random" "&math|random" ""
run_test "func_math_randint" "&math|randint 1 6" ""
run_test "func_math_choice" "&math|choice a b c" ""
run_test "func_math_eval" 'x = &math|eval "2 + 3"' "5"
run_test "func_string_upper" 'x = &string|upper "hello"' "HELLO"
run_test "func_math_factors" "x = &math|factors 12" ""
run_test "func_math_fib" "x = &math|fib 5" ""
run_test "func_math_isprime" "x = &math|isprime 7" "1"
