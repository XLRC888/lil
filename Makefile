...
WLROOTS_CFLAGS = $(shell pkg-config --cflags wlroots wayland-server xkbcommon 2>/dev/null)
WLROOTS_LIBS = $(shell pkg-config --libs wlroots wayland-server xkbcommon 2>/dev/null)
